...
function letter_check() {
    let letter = document.querySelector("#string");
    let lenght = document.querySelector(".lenght");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
    if (lenght) {
        let string_icon = document.querySelector(".is_blank_ok");
        ...
        let letter_icon = document.querySelector(".is_ok");
...
function float_check() {
    let letter = document.querySelector("#floating");
    let float_icon = document.querySelector(".floating_icon");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
...
function ln() {
    let letter = document.querySelector("#letter_number");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
    let ln_icon = document.querySelector(".ln_icon");
    if (!letter_find(letter_val, letter_val.length) && ln_icon)
        ln_icon.innerHTML = "✅";
    else
        ln_icon.innerHTML = "❌";
}
function email_check() {
    let letter = document.querySelector("#email");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
...
function phone_check() {
    let letter = document.querySelector("#phone");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
    let phone_icon = document.querySelector(".phone_icon");
...
function date_check() {
    let letter = document.querySelector("#date");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
    let date_icon = document.querySelector(".date_icon");
...
function password_check() {
    let letter = document.querySelector("#password");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
...
function ip_check() {
    ...
    let letter = document.querySelector("#ip");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
    let ip_icon = document.querySelector(".ip_icon");
...
function number_check() {
    let letter = document.querySelector("#number");
    let letter_val = letter === null || letter === void 0 ? void 0 : letter.value;
    let number_icon = document.querySelector(".number_icon");
    let number = /^\d+$/;
